...
import 'package:foodie_admin/ui/common/widget/app_bar.dart';
...
import 'package:foodie_admin/ui/screens/auth/signin/widget/sign_in_loading_screen.dart';
          ...
          if (state is SignInAccountVerifySuccess) {
            ...
            Navigator.pushNamed(context, Routes.ACCOUNT_VERIFY_SCREEN,
                arguments: AccountVerificationData(
                    otp: state.otp, userData: state.foodieAdmin));
          }
