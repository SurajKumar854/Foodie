...
import 'package:foodie_admin/country_code_picker/selection_dialog.dart';
      ...
      _widget = TextButton(
        style: ButtonStyle(
          overlayColor: MaterialStateProperty.resolveWith<Color>(
                ...
                // Remove the overlay color when hovered
                if (states.contains(MaterialState.hovered)) return Colors.transparent;
                return Colors.transparent; // Use the default overlay color for other states
              }),
        ),
