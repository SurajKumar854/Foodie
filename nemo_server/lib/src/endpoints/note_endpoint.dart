...
class NoteEndpoint extends Endpoint {
  ...
  Future<String> hello(Session session, String name) async {
   ...
   Future<String> shubham(Session session, String name) async {
    return 'Testing $name';
  }
  Future<String> suraj(Session session, String name) async {
    return 'Suraj $name';
  }
  Future<String>sum(Session session, int a,int b) async{
    return "Total is ${a+b}";
  }
