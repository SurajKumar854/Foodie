...
--
-- Class FoodieRestaurants as table food_restaurants
--
...
--
-- Class FoodWhaleUser as table food_whale_user
--
...
--
-- Class FoodieAdmin as table foodie_admin
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('nemo', '20240402054320908', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240402054320908', "timestamp" = now();
